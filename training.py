...
class Trainer:
    """Trainer class for MTAD-GAT models.

    :param model: MTAD-GAT models
    ...
    def fit(self, train_loader, val_loader=None):
        """Train models for self.n_epochs.
        ...
        print(f"Training models for {self.n_epochs} epochs..")
        ...
        for epoch in range(self.n_epochs):
            ...
            for x, y in train_loader:
                ...
                # preds, recons = self.models(x)
                preds, recons = self.model(x, self.target_dims)
    ...
    def save(self, file_name):
        """
        Pickles the models parameters to be retrieved later
